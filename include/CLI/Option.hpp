...
class Option : public OptionBase<Option> {
  ...
  protected:
    ...
    /// The number of arguments that make up one option. -1=unlimited (vector-like), 0=flag, 1=normal option, 2=complex/pair, etc.
    /// Set only when the option is created; this is intrinsic to the type. Eventually, -2 may mean vector of pairs.
    int type_size_{1};
